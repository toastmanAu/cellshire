#!/usr/bin/env python3
"""Install selected generated resource/farm assets as transparent PNGs."""
...
SELECTIONS = [
    {
        "asset_id": "harvest_tree",
        "candidate_id": "harvest_tree_c_stump",
        "source": Path("tmp/resource-asset-generation/resource-candidates/harvest_tree/harvest_tree_c_stump/flux1-schnell-q4-seed10103.png"),
    },
    {
        "asset_id": "stone_outcrop",
        "candidate_id": "stone_outcrop_b_stack",
        "source": Path("tmp/resource-asset-generation/resource-candidates/stone_outcrop/stone_outcrop_b_stack/flux1-schnell-q4-seed10202.png"),
    },
    {
        "asset_id": "gold_nugget_node",
        "candidate_id": "gold_nugget_node_a_matrix",
        "source": Path("tmp/resource-asset-generation/resource-candidates/gold_nugget_node/gold_nugget_node_a_matrix/flux1-schnell-q4-seed10301.png"),
    },
    {
        "asset_id": "farm_plot_ready_crop",
        "candidate_id": "farm_plot_ready_crop_c_full",
        "source": Path("tmp/resource-asset-generation/resource-candidates/farm_plot_ready_crop/farm_plot_ready_crop_c_full/flux1-schnell-q4-seed10403.png"),
    },
]

RAW_DIR = Path("assets/raw")
ASSET_DIR = Path("assets")
OUT_ROOT = Path("tmp/resource-asset-generation/resource-candidates/installed")
